...
*/
app.factory('ToggleHelper', ['$rootScope', '$http',
function ($rootScope, $http) {
    return {
        ...
        toggle: function (target, command) {
            ...
            if(target == 'off-sidebar') {
                if($rootScope.slackInit == false) {
                    $http.get('/new-admin/slackbot/initSupportChat')
                        .then(function (response) {
                            if (response.data.result !== 'success') {
                                $rootScope.slackInitError = true;
                            } else {
                                $rootScope.slackInit = true;
                            }
