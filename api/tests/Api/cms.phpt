 ...
 * @testCase
 */
class SeniorityPresenterTest extends TestCase
{
    /** @var Container  */
    private $container;
    ...
    {
        $client = new Client;
        $response = $client->get($this->server->getUrl() . 'v2/seniority', [
            'cookies' => $this->cookieJar
        ]);
        ...
        try {
            ...
            Assert::type('array', $res->seniority);
...
$testCase = new SeniorityPresenterTest($container);
