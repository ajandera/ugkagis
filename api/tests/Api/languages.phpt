 ...
 * @testCase
 */
class LanguagesPresenterTest extends TestCase
{
    /** @var Container  */
    private $container;
    ...
    {
        $client = new Client;
        $response = $client->get($this->server->getUrl() . 'v2/languages', [
            'cookies' => $this->cookieJar
        ]);
        ...
        try {
            ...
            Assert::type('array', $res->languages);
...
$testCase = new LanguagesPresenterTest($container);
